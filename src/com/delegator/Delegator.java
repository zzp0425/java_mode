...
public class Delegator implements InvocationHandler {
    ...
    protected Object createProxy(Object orgin){
        obj_orgin = orgin;
        //orgin.getClass().getClassLoader()为类加载器
        //orgin.getClass().getInterfaces() 为接口集
        obj_proxy = Proxy.newProxyInstance(orgin.getClass().getClassLoader(), orgin.getClass().getInterfaces(), this);
        return obj_proxy;
    }

    protected Object invokerSuper(Method method, Object[] args) throws InvocationTargetException, IllegalAccessException {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        if("toString".equals(method.getName())){
            return this.invokerSuper(method, args) + "$Proxy";
        } else {
            return this.invokerSuper(method, args);
        }
    }
}
